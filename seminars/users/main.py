...
def send_confirmation_email(email):
    ...
    try:
        ...
        flash_error(
            'Unable to send email confirmation link; please contact <a href="mailto:researchseminars@mit.edu">researchseminars@mit.edu</a> directly to confirm your email.'
        )
