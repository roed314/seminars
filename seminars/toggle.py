...
<label
    ...
    for="{tglid}"
    onclick="this.control.value = ((parseInt(this.control.value) + 2)%3) -1;this.control.dataset.chosen=this.control.value;setTimeout(function () {this.control.dispatchEvent(new Event('change'); }, 50);"
    >
</label>
""".format(
        tglid=tglid,
